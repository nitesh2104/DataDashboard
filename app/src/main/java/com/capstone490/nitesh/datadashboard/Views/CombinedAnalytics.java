 ...
 */
public class CombinedAnalytics extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_combined_analytics);

        mChart = (LineChart) findViewById(R.id.combined_graph);
